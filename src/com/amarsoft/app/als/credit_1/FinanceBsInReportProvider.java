    ...
    public void fillRecord() throws SQLException {
        ...
        while(rs1.next()){
        	 sReportNo=rs1.getString("ReportNo"); if(sReportNo==null) sReportNo =""; 
	          ...
	          b1 = new BigDecimal(m.get("202").toString()).add(new BigDecimal(m.get("203").toString())).add(new BigDecimal(m.get("94705").toString())).add(new BigDecimal(m.get("209").toString()));
	          ...
	          b1 = new BigDecimal(m.get("322").toString()).add(new BigDecimal(m.get("19x").toString()));
