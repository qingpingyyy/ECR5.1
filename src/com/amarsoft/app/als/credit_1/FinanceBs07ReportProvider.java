    ...
    public void fillRecord() throws SQLException {
        ...
        while(rs1.next()){
        	 ...
        	 Map m = new HashMap();
	          ...
	          b1 = new BigDecimal(m.get("101").toString()).add(new BigDecimal(m.get("147").toString())).add(new BigDecimal(m.get("103").toString())).add(new BigDecimal(m.get("104").toString())).add(new BigDecimal(m.get("107").toString())).add(new BigDecimal(m.get("19c").toString())).add(new BigDecimal(m.get("134").toString())).add(new BigDecimal(m.get("108").toString())).add(new BigDecimal(m.get("110").toString())).add(new BigDecimal(m.get("114").toString())).add(new BigDecimal(m.get("115").toString()));
	          ...
	          b1 = new BigDecimal(m.get("162").toString()).add(new BigDecimal(m.get("163").toString())).add(new BigDecimal(m.get("116").toString())).add(new BigDecimal(m.get("164").toString())).add(new BigDecimal(m.get("165").toString())).add(new BigDecimal(m.get("165").toString())).add(new BigDecimal(m.get("120").toString())).add(new BigDecimal(m.get("143").toString())).add(new BigDecimal(m.get("121").toString())).add(new BigDecimal(m.get("166").toString())).add(new BigDecimal(m.get("167").toString())).add(new BigDecimal(m.get("123").toString())).add(new BigDecimal(m.get("168").toString())).add(new BigDecimal(m.get("169").toString())).add(new BigDecimal(m.get("181").toString())).add(new BigDecimal(m.get("126").toString())).add(new BigDecimal(m.get("170").toString()));
	          ...
	          b1 = new BigDecimal(m.get("101").toString()).add(new BigDecimal(m.get("147").toString())).add(new BigDecimal(m.get("103").toString())).add(new BigDecimal(m.get("104").toString())).add(new BigDecimal(m.get("107").toString())).add(new BigDecimal(m.get("19c").toString())).add(new BigDecimal(m.get("134").toString())).add(new BigDecimal(m.get("108").toString())).add(new BigDecimal(m.get("110").toString())).add(new BigDecimal(m.get("114").toString())).add(new BigDecimal(m.get("115").toString())).add(new BigDecimal(m.get("162").toString())).add(new BigDecimal(m.get("163").toString())).add(new BigDecimal(m.get("116").toString())).add(new BigDecimal(m.get("164").toString())).add(new BigDecimal(m.get("165").toString())).add(new BigDecimal(m.get("165").toString())).add(new BigDecimal(m.get("120").toString())).add(new BigDecimal(m.get("143").toString())).add(new BigDecimal(m.get("121").toString())).add(new BigDecimal(m.get("166").toString())).add(new BigDecimal(m.get("167").toString())).add(new BigDecimal(m.get("123").toString())).add(new BigDecimal(m.get("168").toString())).add(new BigDecimal(m.get("169").toString())).add(new BigDecimal(m.get("181").toString())).add(new BigDecimal(m.get("126").toString())).add(new BigDecimal(m.get("170").toString()));
	          ...
	          //currentRecord.getField("DIVIDENDSPAYABLE").setValue(m.get("").toString()); //应付股利            	
	          currentRecord.getField("OTHERPAYABLES").setValue(m.get("208").toString()); //其他应付款 209+210          
	          ...
	          b1 = new BigDecimal(m.get("201").toString()).add(new BigDecimal(m.get("234").toString())).add(new BigDecimal(m.get("202").toString())).add(new BigDecimal(m.get("203").toString())).add(new BigDecimal(m.get("204").toString())).add(new BigDecimal(m.get("274").toString())).add(new BigDecimal(m.get("218").toString())).add(new BigDecimal(m.get("207").toString())).add(new BigDecimal(m.get("208").toString())).add(new BigDecimal(m.get("211").toString())).add(new BigDecimal(m.get("212").toString()));
	          ...
	          b1 = new BigDecimal(m.get("213").toString()).add(new BigDecimal(m.get("214").toString())).add(new BigDecimal(m.get("215").toString())).add(new BigDecimal(m.get("223").toString())).add(new BigDecimal(m.get("222").toString())).add(new BigDecimal(m.get("217").toString())).add(new BigDecimal(m.get("245").toString()));
	          ...
	          b1 = new BigDecimal(m.get("301").toString()).add(new BigDecimal(m.get("302").toString())).add(new BigDecimal(m.get("309").toString())).add(new BigDecimal(m.get("303").toString())).add(new BigDecimal(m.get("305").toString()));
	          currentRecord.getField("TOTALEQUITY").setValue(b1.toString());//所有者权益合计       9153+9154-9155+9156+9157
	          
	          
	          b1 = new BigDecimal(m.get("201").toString()).add(new BigDecimal(m.get("234").toString())).add(new BigDecimal(m.get("202").toString())).add(new BigDecimal(m.get("203").toString())).add(new BigDecimal(m.get("204").toString())).add(new BigDecimal(m.get("274").toString())).add(new BigDecimal(m.get("218").toString())).add(new BigDecimal(m.get("207").toString())).add(new BigDecimal(m.get("208").toString())).add(new BigDecimal(m.get("211").toString())).add(new BigDecimal(m.get("212").toString())).add(new BigDecimal(m.get("213").toString())).add(new BigDecimal(m.get("214").toString())).add(new BigDecimal(m.get("215").toString())).add(new BigDecimal(m.get("223").toString())).add(new BigDecimal(m.get("222").toString())).add(new BigDecimal(m.get("217").toString())).add(new BigDecimal(m.get("245").toString())).add(new BigDecimal(m.get("301").toString())).add(new BigDecimal(m.get("302").toString())).add(new BigDecimal(m.get("309").toString())).add(new BigDecimal(m.get("303").toString())).add(new BigDecimal(m.get("305").toString()));
