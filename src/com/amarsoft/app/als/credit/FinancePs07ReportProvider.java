    ...
    public void fillRecord(){
     try{ 
        ...
        while(rs1.next()){
	         ...
	         b1 = new BigDecimal(m.get("5a1").toString())
			 .subtract(new BigDecimal(m.get("440").toString()))
			 .subtract(new BigDecimal(m.get("504").toString()))
			 .subtract(new BigDecimal(m.get("527").toString()))
			 .subtract(new BigDecimal(m.get("507").toString()))
			 .subtract(new BigDecimal(m.get("508").toString()))
			 .subtract(new BigDecimal(m.get("b58").toString()))
			 .add(new BigDecimal(m.get("5b4").toString()))
			 .add(new BigDecimal(m.get("446").toString()))
			 .add(new BigDecimal(m.get("5b5").toString()));
			 ...
			 .add(new BigDecimal(m.get("446").toString()))
			 .add(new BigDecimal(m.get("5b5").toString()))
			 .add(new BigDecimal(m.get("512").toString()))
			 .add(new BigDecimal(m.get("513").toString()));
			 ...
			 .add(new BigDecimal(m.get("512").toString()))
			 .add(new BigDecimal(m.get("513").toString()))
			 .add(new BigDecimal(m.get("450").toString()));
